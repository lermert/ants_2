...
def hello(args, comm, size, rank):
    ...
    print(rank)
    if rank == 0:
        print("Ants version 1. Type ants -h for more information.")


parser = argparse.ArgumentParser(description="Ambient noise processing tool.")
...
#==============================================================================
def new_project(dummy1,dummy2,dummy3,dummy4):
    if not os.listdir('.')==[]:
...
# Data download
#==============================================================================
def download(args, comm, size, rank):
    from ants_2.scripts.ant_download import ant_download
    ant_download(rank, size, comm)
parser_download = subparsers.add_parser("download",
                                        help='Download data, as specified in \ninput/config_download.json')
parser_download.set_defaults(func=download)
# #==============================================================================
# # Preprocessing
# #==============================================================================
def preprocess(args, comm, size, rank):
    from ants_2.scripts.ant_preprocess import preprocess
    preprocess(rank, size, comm)
parser_preprocess = subparsers.add_parser("preprocess",
                                          help='Preprocess data, as specified in \ninput/config_preprocess.json')
parser_preprocess.set_defaults(func=preprocess)

# #==============================================================================
# # Correlation
# #==============================================================================
def correlation(args, comm, size, rank):
    from ants_2.scripts.ant_correlation import correlate
    correlate(rank, size, comm)

parser_correlate = subparsers.add_parser("correlation",
    help="Run the correlation as specified in \ninput/config_correlation.json")
parser_correlate.set_defaults(func=correlation)
