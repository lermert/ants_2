...
must be above lower corner frequency."
        ...
        while t <= t_end - (win_len_seconds - self.delta):
            ...
            if self.cfg.time_overlap == 0:
                ...
                # deepcopy is used so that processing is not applied directly
                # This is much more expensive than using non-overlapping
                windows = self.data.slice(t, t + win_len_seconds -
                                          self.delta).copy()
